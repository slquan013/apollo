...
void LonController::ComputeLongitudinalErrors(
  ...
  // $)A7V=b5D35A>TK6/5=Frenet35<\IO
  // s_matched: longitudinal accumulated distance along reference trajectory
  //$)A355DN;VCQX2N?<9l<#5DW]Or@[<F>`@k
  // s_dot_matched: longitudinal velocity along reference trajectory
  //$)AQX2N?<9l<#5DW]OrKY6H
  // d_matched: lateral distance w.r.t. reference trajectory
  //$)AQX2N?<9l<#5D:aOr>`@k
  // d_dot_matched: lateral distance change rate, i.e. dd/dt
  //$)A:aOr>`@k1d;/BJ
