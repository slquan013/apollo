...
class LonControllerTest : public ::testing::Test, LonController {
 public:
  virtual void SetUp() {
    ...
    CHECK(jmcauto::common::util::GetProtoFromFile(control_conf_file,
                                                 &control_conf));
 ...
 protected:
  LocalizationPb LoadLocalizationPb(const std::string &filename) {
    ...
    CHECK(jmcauto::common::util::GetProtoFromFile(filename, &localization))
  ...
  ChassisPb LoadChassisPb(const std::string &filename) {
    ...
    CHECK(jmcauto::common::util::GetProtoFromFile(filename, &chassis_pb))
        << "Failed to open file " << filename;
  ...
  TrajectoryPb LoadPlanningTrajectoryPb(const std::string &filename) {
    ...
    CHECK(jmcauto::common::util::GetProtoFromFile(filename, &trajectory_pb))
        << "Failed to open file " << filename;
