...
using jmcauto::common::monitor::MonitorMessage;
using jmcauto::control::ControlCommand;
using jmcauto::control::PadMessage;
...
bool ControlTestBase::test_control() {
  ...
  if (!FLAGS_test_pad_file.empty()) {
    ...
    if (!jmcauto::common::util::GetProtoFromFile(
  ...
  if (!FLAGS_test_monitor_file.empty()) {
    ...
    jmcauto::common::util::GetProtoFromFile(
...
bool ControlTestBase::test_control(const std::string &test_case_name,
                                   int case_num) {
  const std::string golden_result_file = jmcauto::common::util::StrCat(
