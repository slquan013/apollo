...
TEST_F(RelativePositionTest, simple_left) {
  ...
  FLAGS_test_localization_file = "0_jmcauto_localization_pose.pb.txt";
  FLAGS_test_pad_file = "0_pad.pb.txt";
  FLAGS_test_planning_file = "0_jmcauto_planning.pb.txt";
  FLAGS_test_chassis_file = "0_jmcauto_canbus_chassis.pb.txt";
