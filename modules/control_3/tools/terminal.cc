...
using jmcauto::common::time::AsInt64;
using jmcauto::common::time::Clock;
using jmcauto::control::DrivingAction;
...
int main(int argc, char **argv) {
  ...
  using jmcauto::common::adapter::AdapterManagerConfig;
  using jmcauto::common::adapter::AdapterManager;
  using jmcauto::common::adapter::AdapterConfig;
